...
def evaluate_qsnn(pos_start=0, pos_end=99, model_name='qsnn_bw_5', save_dir='../saved_model/',
                   batch_window=5, is_save_result=False, use_cuda=True):
    """
    Evaluate Spiking QSNN in Simulated Environment
    ...
    # input_shape = (1,24,50)
    # flops,macs,params =  calculate_flops(model=actor_net,
    #                                      input_shape=input_shape,
    #                                      output_as_string=True,
    #                                      output_precision=4)
    # print("QSNN: flops:%s,macs:%s,params:%s\n"%(flops,macs,params))
...
if __name__ == '__main__':
    ...
    evaluate_qsnn(use_cuda=USE_CUDA, model_name=MODEL_NAME,
