...
from nets.frcnn_mask_training import (FasterRCNNTrainer, get_lr_scheduler,
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs_figure_layers_5_rpniou0.30.3_dongjie_batch4_bg1_coco2014_sample128'
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '2014_train.txt'
    val_annotation_path     = '2014_val.txt'
