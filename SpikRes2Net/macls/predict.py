...
from macls.models.sres2net import SRes2Net
...
class MAClsPredictor:
    def __init__(self,
        ...
        # 获取模型
        if self.configs.use_model == 'SRes2Net':
            self.predictor = SRes2Net(input_size=self._audio_featurizer.feature_dim, **self.configs.model_conf)
        else:
